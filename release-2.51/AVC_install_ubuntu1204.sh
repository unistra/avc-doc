...
apt-get install vorbis-tools lame ffmpeg libavcodec-extra-53 eyeD3 ffmpeg2theora yamdi zip unzip python2.6 python-reportlab python-psycopg2 atomicparsley bc
...
svn co https://subversion.cru.fr/audiovideocours/tags/server/release-2.51/; mv release-2.51 univ-r_av
echo "------------------------------------"
