...
apt-get install sun-java5-jre postgresql tomcat6 apache2 vsftpd vorbis-tools lame mp32ogg mplayer mencoder lltag ffmpeg libavcodec-unstripped-52 libfaad0 mp3info zip unzip python2.6 python-reportlab mailx libpg-java libcommons-fileupload-java libcommons-io-java libcommons-lang-java libcommons-beanutils-java libcommons-collections3-java libcommons-logging-java ant subversion
